...
# from https://stackoverflow.com/questions/47494305/python-pyqt4-slider-with-tick-labels

class LabeledSlider(QtWidgets.QWidget):
    def __init__(self, minimum, maximum, interval=1, orientation=Qt.Horizontal,
            labels=None, parent=None, divider=1, height=None):
        ...
        if labels is not None:
            ...
            self.levels=list(zip(levels,map(str,np.array(levels)/divider)))
